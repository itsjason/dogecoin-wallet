...
package de.schildbach.wallet.dogecoin.integration.android;
 ...
 */
public final class DogecoinIntegration
{
	private static final String INTENT_EXTRA_TRANSACTION_HASH = "transaction_hash";

	/**
	 * Request any amount of Dogecoins (probably a donation) from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request specific amount of Dogecoins from user, without feedback from the app.
	 * 
	 * @param context
	 *            Android context
	 * @param address
	...
	/**
	 * Request any amount of Dogecoins (probably a donation) from user, with feedback from the app. Result intent can be
	 ...
	 * 
	 * Warning: A success indication is no guarantee! To be on the safe side, you must drive your own Dogecoin
	...
	/**
	 * Request specific amount of Dogecoins from user, with feedback from the app. Result intent can be received by
	...
	/**
	 * Put transaction hash into result intent. Meant for usage by Dogecoin wallet applications.
	 * 
	 * @param result
	 *            result intent
	 * @param txHash
	...
	/**
	 * Get transaction hash from result intent. Meant for usage by applications initiating a Dogecoin payment.
	 * 
	 * You can use this hash to request the transaction from the Dogecoin network, in order to validate. For this, you
	 * need your own Dogecoin infrastructure though. There is no guarantee that the transaction has ever been broadcasted
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://code.google.com/p/dogecoin-wallet/downloads/list"));
